...
/**
 * KINGBASE8 page handler adapter.
 *
 * @author 高露
 * @date 2025-03-04
 */
public class KingPageHandlerAdapter implements PageHandlerAdapter {
    
    @Override
    public boolean supports(String dataSourceType) {
        return PersistenceConstant.KINGBASE8.equals(dataSourceType);
    }
